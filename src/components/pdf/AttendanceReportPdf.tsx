    ...
    <View style={s.reportMetaSection}>
      <View style={s.metaBlock}>
        <Text style={s.metaLine}>
          <Text style={s.metaLabel}>Period: </Text>{period}
        </Text>
        <Text style={s.metaLine}>
          <Text style={s.metaLabel}>Generated By: </Text>{meta.generatedBy}
        </Text>
        <Text style={s.metaLine}>
          <Text style={s.metaLabel}>Generated At: </Text>{meta.generatedAt}
        </Text>
        {filters.branchName && (
          <Text style={s.metaLine}>
            <Text style={s.metaLabel}>Branch: </Text>{filters.branchName}
          </Text>
        )}
        {filters.employeeName && (
          <Text style={s.metaLine}>
            <Text style={s.metaLabel}>Employee: </Text>{filters.employeeName}
          </Text>
        )}
      </View>
    </View>
